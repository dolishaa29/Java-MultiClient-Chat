...
class client5 implements ActionListener
{
Frame f1;
Label l1,l2;
TextArea tx;
...
if(s1.equals("1001"))
{
so2=new Socket("192.168.17.239",1001);
}
else if(s1.equals("1002"))
{
so2=new Socket("192.168.17.178",1002);
}
else if(s1.equals("1003"))
{
so2=new Socket("192.168.17.250",1003);
}
else if(s1.equals("1004"))
{
so2=new Socket("192.168.17.41",1004);
}
